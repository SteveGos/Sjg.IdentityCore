...
namespace Sjg.IdentityCore.Areas.UserMgmt.Pages.AccAuthGroups
{
    public class GroupRolesModel : PageModel
    {
        ...
        public GroupRolesModel(AccAuthContext context)
        {
            _context = context;
        ...
        public IActionResult OnGet()
        {
            ...
            //if (removeId != null)
            //{
            //    var removeItem = _context.AccAuthGroupRoles
            //        .Where(o => o.AccAuthGroupId == id.Value && o.AccessRoleId == removeId.Value).FirstOrDefaultAsync().Result;

            //    if (removeItem != null)
            //    {
            //        _context.AccAuthGroupRoles.Remove(removeItem);
            ...
            //{
            //    qry = _context.AccAuthGroupRoles.Where(o => o.AccAuthGroupId == id).Select(o => o.AccessRole);
            //}
            //else
            //{
            //    qry = _context.AccAuthGroupRoles.Where(o => o.AccAuthGroupId == id &&
